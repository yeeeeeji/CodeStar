...
export default function Directions() {
  ...
  const { mapRef, initializeMap, handleScriptLoad } = useNaverMap(mapContainerRef);
  ...
  return (
    <div id='directions' className='max-w-[1440px] mx-auto sm:mt-[200px]'>
      ...
      <div>
        <div>
          <div ref={mapContainerRef} className='w-full h-[196px] mx-[18px] sm:h-[600px] sm:mx-0 lg:h-[830px]'></div>
          <Script
