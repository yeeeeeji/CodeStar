  ...
  return (
    <div
      className={`
        ...
        bg-codestar-black flex flex-col justify-end
    ...
    >
      ...
      {details.map((detail, index) => (
        <p
          key={index}
          className='text-white text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] xl:text-[22px] 2xl:text-[24px] font-medium'
        >
          {detail}
        </p>
      ))}
